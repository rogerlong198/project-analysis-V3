              ...
              <div className="space-y-4">
                {items.map((item, index) => (
                  <div
                    ...
                    className="flex gap-4 bg-secondary rounded-xl p-4 animate-in fade-in slide-in-from-right-4 fill-mode-both
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <button
                          ...
                          className="ml-auto p-2 text-accent hover:text-accent/80 hover:scale-110 active:scale-90 transition-all duration-200"
                        >
